...
ADVISORY_DATABASE = {
    ...
    # -------------------------------------------------------------------------
    "Wheat___Healthy": {
        "class_name": "Wheat___Healthy",
        "crop": "Wheat",
        "condition": "Healthy",
        "is_healthy": True,
        "overview": "The wheat canopy displays clean, linear green leaf blades free of rust pustules, blighting, or powdery growth.",
        "common_symptoms": [
            "Vibrant green leaf blades without rust spots or chlorosis",
            "Sturdy tillers and healthy flag leaves"
        ],
        "immediate_actions": [
            "Maintain split nitrogen application at tillering and booting stages",
            "Scout canopy weekly during crown root initiation and grain filling"
        ],
        "prevention": [
            "Use certified seeds treated with bio-fungicides",
            "Follow balanced N-P-K fertilization based on soil testing"
        ],
        "monitoring": [
            "Monitor upper leaf blades weekly for orange or yellow rust pustules"
        ],
        "expert_escalation": "Consult local Krishi Vigyan Kendra (KVK) if unexpected tiller drying occurs.",
        "sources": [
            {
                "organization": "ICAR - Indian Institute of Wheat and Barley Research (IIWBR)",
                "title": "Package of Practices for Wheat Production & Scouting Guidelines",
    ...
    "Wheat___Leaf_Rust": {
        "class_name": "Wheat___Leaf_Rust",
        "crop": "Wheat",
        "condition": "Leaf Rust",
        "is_healthy": False,
        "overview": "Leaf rust (Puccinia triticina) causes small, scattered orange-brown pustules on the upper leaf surface, reducing photosynthetic leaf area.",
        "common_symptoms": [
            "Small round orange-brown pustules scattered randomly on leaf blades",
            "Chlorotic halo surrounding individual rust spots",
            "Premature drying of heavily infected upper foliage"
        ],
        "immediate_actions": [
            "Inspect fields for initial rust spots at tillering or boot stage",
            "Avoid excessive early nitrogen fertilization which promotes lush susceptible growth"
        ],
        "prevention": [
            "Sow rust-resistant wheat cultivars recommended for your agro-climatic zone",
            "Avoid late sowing to prevent warm weather overlap during grain fill"
        ],
        "monitoring": [
            "Scout upper canopy weekly following warm humid conditions (>20°C)"
        ],
        "expert_escalation": "Report leaf rust sightings to local KVK or IIWBR Wheat Rust Advisory Desk.",
        "sources": [
            {
                "organization": "ICAR - Indian Institute of Wheat and Barley Research (IIWBR)",
                "title": "Wheat Rust Advisory & Disease Management Protocols",
                "url": "https://iiwbr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    "Wheat___Stripe_Rust": {
        ...
        "is_healthy": False,
        "overview": "Stripe rust / Yellow rust (Puccinia striiformis) forms bright yellow pustules arranged in narrow linear stripes along leaf veins during cool weather.",
        "common_symptoms": [
            "Bright yellow pustules aligned in parallel stripes along leaf veins",
            "Powdery yellow spores rubbing off onto fingers",
            "Leaf desiccation and premature drying in severe focal spots"
        ],
        "immediate_actions": [
            "Mark rust focal spots immediately; avoid walking through infected patches",
            "Eradicate alternate hosts (barberry bushes) around field margins"
        ],
        "prevention": [
            "Plant certified yellow rust resistant varieties (e.g. HD 3086, DBW 222)",
            "Adopt recommended sowing windows to avoid early cool-weather infection"
        ],
        "monitoring": [
            "Scout fields closely during cool, foggy morning periods (Jan-Feb)"
        ],
        "expert_escalation": "CRITICAL: Report yellow rust immediately to District Agriculture Officer and KVK Helpline.",
        "sources": [
            {
                "organization": "ICAR - IIWBR Karnal",
                "title": "Yellow Rust Surveillance & Action Guidelines",
                "url": "https://iiwbr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    "Wheat___Powdery_Mildew": {
        "class_name": "Wheat___Powdery_Mildew",
        "crop": "Wheat",
        "condition": "Powdery Mildew",
        "is_healthy": False,
        "overview": "Powdery mildew (Blumeria graminis) causes white-to-grey cottony fungal patches on leaves and sheath bases in dense, high-humidity stands.",
        "common_symptoms": [
            "White cottony fungal patches on leaf surfaces and sheath bases",
            "Patches turning greyish-brown with tiny black fruiting bodies",
            "Yellowing and premature death of affected foliage"
        ],
        "immediate_actions": [
            "Scout dense crop stands for white mildew patches near plant bases",
            "Avoid overly high seed rate causing canopy overcrowding"
        ],
        "prevention": [
            "Maintain optimum plant spacing for field aeration",
            "Follow balanced potassium and nitrogen soil nutrition"
        ],
        "monitoring": [
            "Check lower leaves during early tillering under humid cloudy weather"
        ],
        "expert_escalation": "Consult KVK plant pathologist if mildew covers flag leaves.",
        "sources": [
            {
                "organization": "ICAR - IIWBR",
                "title": "Foliar Fungal Diseases of Wheat & Integrated Control",
                "url": "https://iiwbr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    "Wheat___Septoria": {
        "class_name": "Wheat___Septoria",
        "crop": "Wheat",
        "condition": "Septoria Leaf Spot",
        "is_healthy": False,
        "overview": "Septoria leaf blotch produces oval greyish-brown leaf lesions peppered with tiny black fruiting specks (pycnidia).",
        "common_symptoms": [
            "Irregular greyish-brown oval lesions on leaf blades",
            "Tiny black dot-like specks (pycnidia) embedded inside lesions",
            "Coalescing blotches causing leaf tip necrosis"
        ],
        "immediate_actions": [
            "Inspect lower leaf canopy after rainy periods",
            "Plow under crop stubble post-harvest to reduce fungal carryover"
        ],
        "prevention": [
            "Practice 2-year crop rotation with non-cereal crops",
            "Sow certified disease-free seed"
        ],
        "monitoring": [
            "Monitor lower and middle leaves following rainy spring days"
        ],
        "expert_escalation": "Consult extension staff if blotching spreads to flag leaf.",
        "sources": [
            {
                "organization": "ICAR - IIWBR",
                "title": "Septoria Blotch Scouting & Cultural Control",
                "url": "https://iiwbr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    # -------------------------------------------------------------------------
    "Maize___Healthy": {
        "class_name": "Maize___Healthy",
        "crop": "Maize",
        "condition": "Healthy",
        "is_healthy": True,
        "overview": "The maize plant displays broad, dark green leaves free of leaf spots, blighting, or rust pustules.",
        "common_symptoms": [
            "Broad green leaf blades without spots or streaking",
            "Sturdy stalk, clean whorl, and healthy root anchorage"
        ],
        "immediate_actions": [
            "Maintain scheduled nitrogen split dressings at knee-high and tasseling stages",
            "Ensure proper field drainage during heavy monsoon rains"
        ],
        "prevention": [
            "Use certified hybrid seed with multi-disease resistance",
            "Maintain recommended plant population per acre"
        ],
        "monitoring": [
            "Scout crop bi-weekly at knee-high, tasseling, and silking stages"
        ],
        "expert_escalation": "Consult local maize specialist if unexpected leaf yellowing or stalk lodging occurs.",
        "sources": [
            {
                "organization": "ICAR - Indian Institute of Maize Research (IIMR)",
                "title": "Good Agricultural Practices for Maize Crop Production",
    ...
    "Maize___Common_Rust": {
        ...
        "is_healthy": False,
        "overview": "Common rust (Puccinia sorghi) produces oval, brownish-red pustules on both upper and lower surfaces of maize leaves.",
        "common_symptoms": [
            "Small oval brownish-red pustules on both leaf surfaces",
            "Pustules rupturing to release powdery golden-brown spores",
            "Chlorotic yellowing around dense pustule clusters"
        ],
        "immediate_actions": [
            "Inspect leaf undersides for brownish pustules during cool moist weather",
            "Avoid late season sowing in high-altitude or cool zones"
        ],
        "prevention": [
            "Plant resistant maize hybrids recommended by ICAR-IIMR",
            "Destroy crop residue post harvest"
        ],
        "monitoring": [
            "Scout field prior to tasseling stage"
        ],
        "expert_escalation": "Consult KVK maize extension officer if rust covers over 15% leaf canopy.",
        "sources": [
            {
                "organization": "ICAR - Indian Institute of Maize Research (IIMR)",
                "title": "Maize Common Rust Diagnosis & Advisory",
                "url": "https://iimr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    "Maize___Northern_Leaf_Blight": {
        "class_name": "Maize___Northern_Leaf_Blight",
        "crop": "Maize",
        "condition": "Northern Leaf Blight",
        "is_healthy": False,
        "overview": "Northern leaf blight (Exserohilum turcicum) causes long, elliptical cigar-shaped tan lesions on leaf blades.",
        "common_symptoms": [
            "Long, elliptical cigar-shaped greyish-green to tan lesions (2-15 cm)",
            "Dark sporangia fungal dust visible inside lesions during wet weather",
            "Extensive leaf blighting causing premature canopy drying"
        ],
        "immediate_actions": [
            "Inspect lower leaves for cigar-shaped lesions during warm humid weather",
            "Deeply plow under infected crop residue after harvest"
        ],
        "prevention": [
            "Rotate maize with non-graminaceous crops (pulses, soybean, cotton)",
            "Plant resistant cultivars suited to your region"
        ],
        "monitoring": [
            "Scout lower leaves starting at knee-high stage through silking"
        ],
        "expert_escalation": "Escalate to district agronomy team if blighting reaches ear leaf before silking.",
        "sources": [
            {
                "organization": "ICAR - IIMR Ludhiana",
                "title": "Integrated Management of Northern Corn Leaf Blight",
                "url": "https://iimr.icar.gov.in",
                "source_type": "ICAR",
                "verified_url": True
            }
    ...
    "Maize___Gray_Leaf_Spot": {
        "class_name": "Maize___Gray_Leaf_Spot",
        "crop": "Maize",
        "condition": "Gray Leaf Spot",
        "is_healthy": False,
        "overview": "Gray leaf spot (Cercospora zeae-maydis) forms narrow rectangular tan-to-grey lesions delimited by leaf veins.",
        "common_symptoms": [
            "Narrow rectangular tan-to-grey lesions restricted between parallel leaf veins",
            "Lesions turning greyish under humid conditions",
            "Coalescing lesions causing blighting of entire leaf blade"
        ],
        "immediate_actions": [
            "Check lower foliage for rectangular vein-limited spots",
            "Avoid continuous maize monoculture in minimum-tillage fields"
        ],
        "prevention": [
            "Adopt 2-year crop rotation with non-cereal crops",
            "Plant tolerant hybrids certified by SAUs"
        ],
        "monitoring": [
            "Scout canopy weekly from pre-tasseling to grain fill stage"
        ],
        "expert_escalation": "Consult KVK if rectangular lesions coalesce on leaves above ear level.",
        "sources": [
            {
